...
6. **Write & self-review.** Save the plan to `implementation-plans/<feature-slug>.md` (descriptive kebab-case). Then check it yourself: every requirement maps to a step, no placeholders, consistent naming. Get approval before writing code.
