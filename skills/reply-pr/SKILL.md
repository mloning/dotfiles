...
1. **Fetch open comments.** Get all unresolved review comments for the current branch's PR — GitHub MCP or `gh pr view --comments`. Note the PR number and each reviewer.
