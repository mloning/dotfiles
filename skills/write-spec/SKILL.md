...
2. **Survey the field.** Once scoped, research prior art and existing solutions (web search / the `research` skill) to ground the requirements and surface constraints you'd otherwise miss.
