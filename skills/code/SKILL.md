...
4. **Name things precisely.** Names should describe what something IS or DOES, not how it works internally. Prefer domain vocabulary over technical jargon. If a name needs a comment to explain it, rename it.
